...
# Best model is the Update_bank_model, we chose t-tests above 2 for all and this gave us the highest F-stat of all summary data.
# Futhermore coeffiecnts like Job and Month were removed as they were insignificant and difficult to interpret
